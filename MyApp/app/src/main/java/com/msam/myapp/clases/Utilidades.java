...
public class Utilidades {
    ...
    public static final String NOMBRE_BD="myapp_bd";
    ...
    public static final String CREAR_TABLA_JUGADOR="CREATE TABLE "+TABLA_JUGADOR+" ("+CAMPO_ID+" INTEGER PRIMARY KEY, "+CAMPO_NOMBRE+" TEXT,"+CAMPO_EDAD+" TEXT,"+CAMPO_AVATAR+" INTEGER)";
    ...
    public static void consultarListaJugadores(Activity actividad) {
        ...
        while (cursor.moveToNext()){
            ...
            jugador.setEdad(cursor.getString(2));
